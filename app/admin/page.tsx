        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <Link href="/admin/categories" className="font-medium text-blue-700 hover:text-blue-900">
                    View all categories
                  </Link>
                </div>
              </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div className="bg-gray-50 px-5 py-3">
                <div className="text-sm">
                  <Link href="/admin/analytics" className="font-medium text-blue-700 hover:text-blue-900">
                    View analytics
                  </Link>
                </div>
              </div>
